...
import { LayoutDashboard, BookOpen, Award, UserCircle, MessageSquare, Download, Settings } from 'lucide-react';
...
const StudentLayout = () => {
  ...
  const navItems = [
    ...
    { to: '/student/achievements', label: 'Achievements (BETA)', icon: Award },
    { to: '/student/qna', label: 'Q&A Assistant (BETA)', icon: MessageSquare },
    { to: '/student/offline', label: 'Offline Mode (BETA)', icon: Download },
